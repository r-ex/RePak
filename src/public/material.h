...
struct MaterialShaderBufferV15
{
	...
	float c_uvDistortionIntensity[2] = {1.000000, 1.000000};
	float c_uvDistortion2Intensity[2] = {1.000000, 1.000000};
	...
	float c_outlineColorSDF[3] = {0.000000, 0.000000, 0.000000};
	float c_outlineWidthSDF = 0.000000;
	float c_shadowColorSDF[3] = {0.000000, 0.000000, 0.000000};
	float c_shadowWidthSDF = 0.000000;
	float c_insideColorSDF[3] = {0.000000, 0.000000, 0.000000};
	...
	float c_dropShadowOffsetSDF[2] = {0.000000, 0.000000};
	float c_normalMapEdgeWidthSDF = 0.000000;
	float c_shadowFalloffSDF = 0.000000;
	float c_L0_scatterAmount[3] = {0.000000, 0.000000, 0.000000};
	float c_L0_scatterRatio = 0.000000;
	float c_L0_transmittanceIntensityScale = 1.000000;
	float c_vertexDisplacementDirection[3] = {0.000000, 0.000000, 0.000000};
	...
	float c_L0_albedoTint[3] = {1.000000, 1.000000, 1.000000};
	float c_depthBlendScalar = 1.000000;
	float c_L0_emissiveTint[3] = {1.000000, 1.000000, 1.000000};
	char UNIMPLEMENTED_c_subsurfaceMaterialID[4];
	float c_L0_perfSpecColor[3] = {0.037972, 0.037972, 0.037972};
	float c_L0_perfGloss = 1.000000;
	float c_L1_albedoTint[3] = {0.000000, 0.000000, 0.000000};
	float c_L1_perfGloss = 0.000000;
	float c_L1_emissiveTint[3] = {0.000000, 0.000000, 0.000000};
	float c_L1_perfSpecColor[3] = {0.000000, 0.000000, 0.000000};
	float c_splineMinPixelPercent = 0.000000;
	float c_L0_anisoSpecCosSinTheta[2] = {1.000000, 0.000000};
	float c_L1_anisoSpecCosSinTheta[2] = {1.000000, 0.000000};
	...
	float c_L1_scatterAmount[3] = {0.000000, 0.000000, 0.000000};
